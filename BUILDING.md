...
build it; see `README.md` and `docs/VALIDATION-v4.md` for current behavior and checks.
...
are separate checks. Current app verification is recorded in `docs/VALIDATION-v4.md`.
